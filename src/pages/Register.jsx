...
const Register = () => {
  const [error, setError] = useState({}); // Initialize as an object
        ...
        <div className="card w-full max-w-lg shrink-0 rounded p-10">
          ...
          <form onSubmit={handleSubmit} className="card-body">
            <button 
              ...
              type="button" 
              className="w-full flex items-center justify-center gap-4 py-2.5 px-4 text-sm tracking-wide font-bold text-gray-800 border border-gray-300 rounded-md bg-transparent hover:bg-gray-50 focus:outline-none"
            >
          ...
          <p className="text-center font-semibold">
            ...
            <Link className="text-[#0B3169]" to="/login">
              Login
            </Link>
          </p>
        </div>
